...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<HttpStatus> createUser(@RequestBody @Valid Users user, BindingResult bindingResult) {
    ...
    @PutMapping
    public ResponseEntity<HttpStatus> updateUserById(@RequestBody @Valid Users user, BindingResult bindingResult ) {
        if (bindingResult.hasErrors()) {
            for (ObjectError o : bindingResult.getAllErrors()) {
                log.warn(o.getDefaultMessage());
            }
